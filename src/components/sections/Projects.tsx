...
export default function Projects() {
  return (
    <section
      ...
      {/* 첫번째 프로젝트 wrapper */}
      <div
        className={cn('w-full max-w-[560px] bp960:max-w-[1860px]', 'bp960:px-22 bp1200:px-5 mb-10', 'flex gap-[30px]')}>
        {/* 왼쪽 설명 */}
        <div className={cn('flex flex-col gap-[12px] bp960:flex-1 bp960:mt-5 bp1200:flex-[10]')}>
          <figure className={cn('relative min-w-0 aspect-[6/3] rounded-md overflow-hidden shadow-sm')}>
        ...
        <div
          className={cn(
            ...
            'bg-[#f7f7f7] rounded-md shadow-sm',
          )}>
          <figure
            className={cn(
              'hidden',
